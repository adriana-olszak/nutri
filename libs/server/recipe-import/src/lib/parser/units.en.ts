...
ingredientUnits.set('litre', liter);
...
const ingredientSizes: string[] = ['large', 'medium', 'small'];
...
const temperatureMarkers: string[] = ['°', 'degree', 'degrees'];

const ingredientPrepositions: string[] = ['of'];
...
const ingredientRangeMarker: string[] = ['to', '-', 'or'];

const ingredientQuantityAddMarker: string[] = ['and'];
...
const ingredientExtraMarkers = ['optional', 'or', 'ie,', 'eg,', 'e.g,', 'i.e,']
const ingredientParenthesisMarkers =['(', ')']
const precisionOrder =  ['g', 'mg', 'ml', 'oz', 'lb', 'cup', 'tbsp', 'tsp']

const englishUnits: Units = {
  ingredientUnits,
  ingredientSizes,
  timeUnits,
  timeUnitMultipliers,
  ...
  ingredientExtraMarkers,
  ingredientParenthesisMarkers,
  precisionOrder
};
