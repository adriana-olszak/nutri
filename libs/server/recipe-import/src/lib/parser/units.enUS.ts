...
const converters: Map<string, (input: number) => number> = new Map(DefaultEnglish.unitConversions.converters);
...
const americanEnglishUnits: Units = {
  ...
  ingredientExtraMarkers: DefaultEnglish.ingredientExtraMarkers,
  ingredientParenthesisMarkers: DefaultEnglish.ingredientParenthesisMarkers,
  precisionOrder: DefaultEnglish.precisionOrder
};

export default americanEnglishUnits;
