  ...
  ['transition duration-300 ease-in-out transform scale-100'],
  {
    variants: {
      iconColorScheme: {
        ...
        lavender: ['fill-lavender-600 text-lavender-600'],
        airForceBlue: ['fill-airForceBlue-600 text-airForceBlue-600'],
        blue: ['fill-blue-600 text-blue-600'],
        keppel: ['fill-keppel-600 text-keppel-600'],
...
export interface CheckboxProps
  extends VariantProps<typeof iconColor> {
  id?: string;
  tabIndex?: number;
  dataTest?: string;
  disabled?: boolean;
  ...
  (
    ...
    return (
      <div className='flex items-center gap-2'>
        ...
        {children && (
          <label {...labelProps} htmlFor={id} tabIndex={-1}>
            {children}
          </label>
        )}
      </div>
