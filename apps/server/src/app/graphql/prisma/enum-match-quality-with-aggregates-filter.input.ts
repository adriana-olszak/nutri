...
import { NestedEnumMatchQualityWithAggregatesFilter } from './nested-enum-match-quality-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMatchQualityFilter } from './nested-enum-match-quality-filter.input';

@InputType()
export class EnumMatchQualityWithAggregatesFilter {
