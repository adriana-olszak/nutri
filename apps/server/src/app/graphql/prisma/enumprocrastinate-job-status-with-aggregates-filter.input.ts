...
import { NestedEnumprocrastinate_job_statusWithAggregatesFilter } from './nested-enumprocrastinate-job-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumprocrastinate_job_statusFilter } from './nested-enumprocrastinate-job-status-filter.input';

@InputType()
export class Enumprocrastinate_job_statusWithAggregatesFilter {
