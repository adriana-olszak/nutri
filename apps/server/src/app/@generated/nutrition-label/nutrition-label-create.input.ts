...
import { BrandedFoodCreateNestedOneWithoutNutritionLabelInput } from '../branded-food/branded-food-create-nested-one-without-nutrition-label.input';

@InputType()
export class NutritionLabelCreateInput {
    ...
    @Field(() => BrandedFoodCreateNestedOneWithoutNutritionLabelInput, {nullable:false})
    brandedFood!: BrandedFoodCreateNestedOneWithoutNutritionLabelInput;
}
