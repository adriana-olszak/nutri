...
import { BrandedFoodUpdateOneRequiredWithoutNutritionLabelNestedInput } from '../branded-food/branded-food-update-one-required-without-nutrition-label-nested.input';

@InputType()
export class NutritionLabelUpdateInput {
    ...
    @Field(() => BrandedFoodUpdateOneRequiredWithoutNutritionLabelNestedInput, {nullable:true})
    brandedFood?: BrandedFoodUpdateOneRequiredWithoutNutritionLabelNestedInput;
}
