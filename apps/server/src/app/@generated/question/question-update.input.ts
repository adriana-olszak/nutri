...
import { SectionUpdateOneRequiredWithoutQuestionsNestedInput } from '../section/section-update-one-required-without-questions-nested.input';
...
export class QuestionUpdateInput {
    ...
    @Field(() => SectionUpdateOneRequiredWithoutQuestionsNestedInput, {nullable:true})
