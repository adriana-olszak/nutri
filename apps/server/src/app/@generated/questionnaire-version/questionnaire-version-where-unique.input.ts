...
import { QuestionnaireVersionQuestionnaireIdVersionNumberCompoundUniqueInput } from './questionnaire-version-questionnaire-id-version-number-compound-unique.input';
...
@InputType()
export class QuestionnaireVersionWhereUniqueInput {

    @Field(() => String, {nullable:true})
    id?: string;

    @Field(() => QuestionnaireVersionQuestionnaireIdVersionNumberCompoundUniqueInput, {nullable:true})
    questionnaireId_versionNumber?: QuestionnaireVersionQuestionnaireIdVersionNumberCompoundUniqueInput;
