...
import { ImportInfoDataSourceSourceVersionCompoundUniqueInput } from './import-info-data-source-source-version-compound-unique.input';
...
@InputType()
export class ImportInfoWhereUniqueInput {

    @Field(() => String, {nullable:true})
    id?: string;

    @Field(() => ImportInfoDataSourceSourceVersionCompoundUniqueInput, {nullable:true})
    dataSource_sourceVersion?: ImportInfoDataSourceSourceVersionCompoundUniqueInput;
