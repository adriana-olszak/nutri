...
import { NutrientUpdateManyWithoutImportInfoNestedInput } from '../nutrient/nutrient-update-many-without-import-info-nested.input';
...
@InputType()
export class ImportInfoUpdateWithoutFoodCategoriesInput {
    ...
    @Field(() => NutrientUpdateManyWithoutImportInfoNestedInput, {nullable:true})
    nutrients?: NutrientUpdateManyWithoutImportInfoNestedInput;
